# Program to generate the sounds of notes of a melodic minor scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a melodic minor scale
    notes_interval = [2, 1, 2, 2, 2, 2, 1, 1]
    rev_interval = [0, 1, 2, 2, 2, 2, 1, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies of notes in the {notescale} melodic minor scale in ascending order')
    ...
    print()
    print(f'The frequencies of notes in the {notescale} melodic minor scale in descending order')
    ...
    # Return list of frequencies in the ascending and descending notes of the melodic minor scale    
...
# Scale list for which the melodic minor scale will be played in sequence
scale_list = ['C4', 'G4', 'F4', 'A4', 'D4', 'C5']
